  ...
  return (
    <>
      ...
      <div className="bg-[#000] flex flex-col md:flex-row pt-24 px-5 md:px-24 pb-20 gap-10">
        <div className="bg-[#161616] mx-auto md:w-[30%] px-10 rounded-lg pb-10">
            ...
            <div className="flex flex-col w-full">
              ...
              >
                ...
                <input
                  ...
                  className="bg-[#161616] mt-5 text-white w-full border-[grey] border-[1px] rounded-lg p-2 font-medium focus:outline-none focus:border-[#ff4d24]"
                />
              </label>
            </div>
          </div>
            ...
            <div className="flex flex-col w-full">
              ...
              >
                ...
                <input
                  ...
                  className="bg-[#161616] mt-5 w-full text-white border-[grey] border-[1px] rounded-lg p-2 font-medium focus:outline-none focus:border-[#ff4d24]"
                />
              </label>
            </div>
          </div>
            ...
            <table className="table-auto mt-10">
              ...
              <tbody>
                {orders.map((order) => (
                  <tr
                    key={order._id}
                    className="border-b-[1px] border-[#fae115]"
                  >
